...
namespace Client.CodeGenerator
{
    public static class TypeExtensions
    {
        ...
        {
            if (type.IsArray)
                return type.Namespace + "." + type.GetFriendlyNameOfArrayType();
            if (type.IsGenericType)
                return type.Namespace + "." + type.GetFriendlyNameOfGenericType();
            if (type.IsPointer)
                return type.Namespace + "." + type.GetFriendlyNameOfPointerType();
